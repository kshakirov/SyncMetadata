class CreateCriticalDimsTriggers < ActiveRecord::Migration
    ...
    def up
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `piston_ring_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `journal_bearing_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `gasket_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `compressor_wheel_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `turbine_wheel_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `bearing_housing_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `nozzle_ring_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `clamp_update_trigger`
        SQL
        execute <<-SQL
        CREATE TRIGGER `clamp_update_trigger` AFTER UPDATE ON `clamp`
        FOR EACH ROW BEGIN
          INSERT INTO part_audits Set action = 'update', part_id = NEW.part_id, created_at = NOW(), updated_at= NOW();
        END;
        SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `backplate_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `bolt_screw_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `fitting_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `journal_bearing_spacer_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `nut_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `pin_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `retaining_ring_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `seal_plate_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `spring_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `thrust_bearing_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `thrust_collar_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `thrust_spacer_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `thrust_washer_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `washer_update_trigger`
        SQL
        execute <<-SQL
        ...
        execute <<-SQL
          DROP TRIGGER  IF EXISTS `carbon_seal_update_trigger`
        SQL
        execute <<-SQL
    ...
    def down
        ...
        execute <<-SQL
          DROP TRIGGER `clamp_update_trigger`
        SQL
